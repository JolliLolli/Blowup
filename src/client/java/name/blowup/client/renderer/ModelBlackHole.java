...
public class ModelBlackHole extends EntityModel<EntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		float offsetY = 24.0F;
		ModelPartData bone = modelPartData.addChild("bone", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, offsetY, 0.0F));
		...
		.uv(4, 28).cuboid(-1.0F, -9.5F, 7.7016F, 1.0F, 3.0F, 0.5967F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, -8.0F));
		...
		.uv(28, 20).cuboid(-1.0F, -9.5F, 7.7016F, 1.0F, 3.0F, 0.5967F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, -8.0F));
